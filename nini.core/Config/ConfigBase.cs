...
namespace Nini.Config
{
	...
	public class ConfigBase : IConfig
	{
        ...
        IFormatProvider format = NumberFormatInfo.InvariantInfo;
		#endregion
		...
		public AliasText Alias { get; } = null;
		...
		{
			return Alias.ContainsInt(key, alias) ? Alias.GetInt(key, alias) : ConfigSource.Alias.GetInt(key, alias);
        }
