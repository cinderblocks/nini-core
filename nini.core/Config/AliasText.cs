...
namespace Nini.Config
{
	...
	public class AliasText
	{
		...
		public AliasText ()
		{
			intAlias = CollectionsUtil.CreateCaseInsensitiveHashtable();
			booleanAlias = CollectionsUtil.CreateCaseInsensitiveHashtable();
			DefaultAliasLoad ();
		}
		#endregion
		...
		public void AddAlias (string key, string alias, int value)
		{
            ...
            {
                Hashtable keys = CollectionsUtil.CreateCaseInsensitiveHashtable();
