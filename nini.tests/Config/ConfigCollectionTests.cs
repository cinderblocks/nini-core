...
namespace Nini.Test.Config
{
	...
	public class ConfigCollectionTests
	{
		...
		public void GetConfig ()
		{
			...
			ConfigCollection collection = new ConfigCollection (null) { config1 };
		...
		{
			var config = new ConfigBase ("Test", null);
		    var collection = new ConfigCollection(null) {config};
